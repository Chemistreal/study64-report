...
| `style/02_common.css` | 135 | 공통 자리. 카드와 단추와 표 |
| `style/03_timer.css` | 237 | 시계와 블록 칸과 집중 화면 |
...
조각 41개 4981줄이다. **한 조각은 500줄을 안 넘는다.**
