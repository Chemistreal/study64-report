...
| `style/03_timer.css` | 289 | 시계와 블록 칸과 집중 화면 |
| `style/04_parts.css` | 267 | 차트와 규칙 카드와 인쇄 |
...
| `js/03_plan.js` | 372 | 오늘 배정과 오늘 한 장 |
| `js/04_today.js` | 224 | 탭 몰기와 오늘 탭 그리기 |
| `js/05_session.js` | 304 | 시계와 세션 상태와 기기 쪽 |
| `js/06_cards.js` | 232 | 카드 뷰어와 간격 반복과 근거 |
| `js/07_block14.js` | 287 | 블록 1과 4. 미디어를 그 자리에서 |
| `js/07b_tone.js` | 61 | 소리 여섯. 시작 넘김 되풀이 교대 판끝 세션끝 |
| `js/08_script.js` | 469 | 대본 동기와 되풀이와 배속 |
| `js/09_lecture.js` | 181 | 강의 본문 96편. 읽는 자리 |
| `js/10_run.js` | 162 | 블록 몰기. 넘김과 되돌림 |
| `js/11_ledger.js` | 195 | 대장 탭 |
...
| `js/19_library.js` | 356 | 미디어 라이브러리 52과 |
| `js/20_docs.js` | 265 | 자료와 규칙과 시작 |
| `page/03_close.html` | 3 | script 닫고 body 닫기 |

조각 43개 5821줄이다. **한 조각은 500줄을 안 넘는다.**
