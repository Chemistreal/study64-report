...
| `style/02_common.css` | 148 | 공통 자리. 카드와 단추와 표 |
| `style/03_timer.css` | 241 | 시계와 블록 칸과 집중 화면 |
| `style/04_parts.css` | 217 | 차트와 규칙 카드와 인쇄 |
...
조각 42개 5170줄이다. **한 조각은 500줄을 안 넘는다.**
