...
| `style/04_parts.css` | 453 | 차트와 규칙 카드와 인쇄 |
...
| `js/03_plan.js` | 488 | 오늘 배정과 오늘 한 장 |
...
| `js/24b_side.js` | 298 | 판 화면. 쪽 표시와 교대 알림과 가리기와 자리 맞추기 |
| `js/25_play.js` | 133 | 판 목록과 틀. **판 화면 자체는 english.html 에 안 들어간다** |
...
조각 62개 10874줄이다. **한 조각은 500줄을 안 넘는다.**
