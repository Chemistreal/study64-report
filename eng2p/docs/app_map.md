...
| `style/03_timer.css` | 260 | 시계와 블록 칸과 집중 화면 |
...
| `js/19_library.js` | 347 | 미디어 라이브러리 52과 |
| `js/20_docs.js` | 265 | 자료와 규칙과 시작 |
| `page/03_close.html` | 3 | script 닫고 body 닫기 |

조각 43개 5598줄이다. **한 조각은 500줄을 안 넘는다.**
