...
| `style/04_parts.css` | 387 | 차트와 규칙 카드와 인쇄 |
...
| `js/04_today.js` | 231 | 탭 몰기와 오늘 탭 그리기 |
...
| `js/23_merge.js` | 355 | 합치기. **덮는 것이 아니다.** 못 정하는 것은 사람에게 묻는다 |
| `js/24_round.js` | 301 | 같은 판. **망 없이 셈으로 맞춘다.** 시계에서 아무것도 안 낸다 |
| `js/24b_side.js` | 279 | 판 화면. 쪽 표시와 교대 알림과 가리기와 자리 맞추기 |
| `js/20_docs.js` | 285 | 자료와 규칙과 시작 |
| `page/03_close.html` | 3 | script 닫고 body 닫기 |

조각 49개 7985줄이다. **한 조각은 500줄을 안 넘는다.**
