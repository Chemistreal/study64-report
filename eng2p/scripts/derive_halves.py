...
# 한 판이 여섯 문장이다 (규칙서 4.2 끝 조건).
#
# **여덟이던 것을 서른여섯으로 올렸다** (T416). 여덟은 "넉넉히" 로 정한 수였고
# 재 보니 넉넉하지 않았다. `check_supply.js` 가 이 판을 288일 돌려 보고
# **안 잼** 으로 적었다. 자루가 여덟인데 어제 여섯 오늘 여섯을 내면
# 그 둘을 합친 것보다 자루가 큰 날이 하루도 없다.
...
# 그 엿새 동안 어제 붙인 문장이 오늘 또 나오지 않으려면 자루가 그만큼은 돼야 한다.
# 대본에서 나오는 것이 과마다 평균 스물하나라 **이 뚜껑은 대개 안 걸린다.**
#
# **자르는 규격은 안 건드렸다.** 낱말 6~12 와 한 토막 둘은 그대로다.
# 그것을 늘리면 붙여 말하기가 달라지고 그것은 자루 이야기가 아니다.
PER = 36
