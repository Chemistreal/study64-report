...
TARGETS = [
    ...
    # 리허설 기록과 인계 문서는 T153 과 T157 에 생겼다. 둘 다 하나씩이다.
    # 매뉴얼류 셈에 안 들어간다. 그 자리는 운영 매뉴얼과 진행 대장 둘로 고정이다.
    ("manual", "실행 리허설 기록", 1, r"^#\s+\d+주차 실행 리허설"),
    ("manual", "인계 문서", 1, r"^#\s+\d+년차 인계 문서"),
    ...
    # 묶음은 강의록의 파생물이다. 분기마다 하나라 넷이어야 한다.
    ("bundles", "강의록 묶음", 4, None),
]
