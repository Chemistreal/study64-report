...
function renderMapPane(){
  ...
  /* **밀린 것은 없어진 것이 아니라 미뤄진 것이다** (T181, T356).
     ...
     밀림이 0이면 아예 안 뜬다. **0인데 뜨면 그것은 잔소리다.**
     이 줄이 언젠가 없어졌고 숫자만 남아 있었다. 숫자만 있으면 그것이 빚으로 읽힌다. */
  if(pl.behind>0)
    h+='<div class="wnote">밀린 것은 <b>없어진 것이 아니라 미뤄진 것이다.</b> '+
       '진도는 정상 세션으로만 세므로 오늘 한 만큼 그대로 간다. '+
       '따라잡으려고 하루에 둘을 하지 않는다.</div>';
